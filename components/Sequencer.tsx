...
import { Icon, Link, IconButton } from '@chakra-ui/react';
...
const Sequencer = (props: any) => {
  return (
    <div>
      ...
      <footer style={{ position: 'fixed', bottom: 0, display: 'flex', justifyContent: 'center', alignItems: 'center', width: '100%', backgroundColor: '#eee' }}>
        <p style={{ display: 'flex', alignItems: 'center', fontWeight: 'bold', fontSize: 14, marginBottom: '2px' }}>Made with <Icon as={FaHeart} mx="3px" color="red.600" /> for <Link href="http://compo.thasauce.net/compos/view/2HTS" mx="3px" color="teal.600" isExternal>2HTS</Link></p>
        <Link href="https://github.com/jurelik/wesequence" display="flex" alignItems="center" isExternal><Icon as={FaGithub}/></Link>
      </footer>
    </div>
  )
}
